# List of Art used: Cheap AI art mountain lake trees, Cheap AI art street lights and trees, Edvard Munch The Scream 1893, Georges Seurat A Sunday Afternoon on the Island of La Grande Jatte 1884–1886, Georgia O’Keeffe Red Canna 1924, Johanne Vermeer The Girl With a Pearl Earring 1632-1675, René Magritte The Son of Man 1964

this is the art database add it:
...
art_database = {
    ...
    "Cheap_AI_art_street_lights_and_trees": {
    ...
    "Georges_Seurat_A_Sunday_Afternoon_on_the_Island_of_La_Grande_Jatte_1884_1886": {
    ...
    "Georgia_OKeeffe_Red_Canna_1924": {
    ...
    "Johannes_Vermeer_The_Girl_With_a_Pearl_Earring_1632_1675": {
        "name
        "remark": 'This is a very famous painting and I think it will sell for a ton of money',
        "artist": "Johannes Vermeer",
        "year": "Circa 1665",
        "style": "Dutch Golden Age",
        "description": "Often referred to as the 'Mona Lisa of the North', this painting is renowned for its exquisite detail and emotional depth.",
        "appraisal": "one hundred and twenty million dollars"
    },
    "Rene_Magritte_The_Son_of_Man_1964": {
        "artist": "René Magritte",
        "year": "1964",
        "style": "Surrealism",
        "description": "A self-portrait with a twist, 'The Son of Man' skillfully plays with reality and perception, featuring a man's face obscured by a floating apple.",
        "appraisal": "twenty seven million dollars"
    }
}
