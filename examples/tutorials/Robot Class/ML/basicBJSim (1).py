...
attribute_names = ['dealer_card','dealer_value','dealer_bust','init_hand','hit','result','outcome']
new_df_attributes = []
for index in range(players):
    ...
    new_df_attributes.append(['dealer_card','dealer_value','dealer_bust',att1, att2, att3, att4])
